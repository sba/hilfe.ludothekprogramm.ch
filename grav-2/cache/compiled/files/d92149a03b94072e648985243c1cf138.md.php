...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/10.ludothek-webseite/01.aufbau-der-webseite/docs.de.md',
    'modified' => 1786606028,
    'size' => 1152,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Aufbau der Webseite\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Der Inhalt der Website ist in verschiedene Bereiche unterteilt. Beiträge können direkt im Frontend bearbeitet werden, der andere Inhalt (Module) wird im Administrator verwaltet.
