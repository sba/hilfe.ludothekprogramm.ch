...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/04.spiele-ausleihen/08.kunden-und-ausleihkonto/docs.de.md',
    'modified' => 1786606028,
    'size' => 5717,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Kunden- und Ausleihkonto\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Jeder Kunde hat zwei Konten, ein Kundenkonto und ein Ausleihkonto. Das Geld auf dem Ausleihkonto wird über das Einlösen eines Gutscheins deponiert und kann nur für Ausleihgebühren verwendet werden. Der Kundenkontostand kann mit dem Knopf Kunde bezahlt auf 0 gesetzt werden. Der Kunde bezahlt in Bar.
