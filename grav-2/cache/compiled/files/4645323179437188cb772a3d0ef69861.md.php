...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/07.buchhaltung/06.manuell-buchen-individuell/docs.de.md',
    'modified' => 1786606028,
    'size' => 583,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Manuell buchen (Individuell)\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das **Einzelbuchungen individuell** Fenster können Sie mit dem Übersichtsbefehl **Übersicht → Buchhaltung → Manuell buchen (individuell)** öffnen.
