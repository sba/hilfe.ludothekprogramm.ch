...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/04.spiele-ausleihen/07.spiele-reservieren/docs.de.md',
    'modified' => 1786606028,
    'size' => 2178,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Spiele reservieren\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Sie können Spiele auf den im Fenster **Spiele ausleihen und zurücknehmen** angezeigten Kunden reservieren. Geben Sie die Spielnummer in das Feld ein um dann mit dem <span class="btn-lupo">Reservieren</span> Button die Reservation mit den unthalb definierten Daten zu speichern.
