...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/03.start/03.uebersicht/docs.de.md',
    'modified' => 1786606028,
    'size' => 1307,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Übersicht
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Die **Übersicht** wird automatisch beim Starten von **LUPO** geöffnet. Sie kann auch via [Menüband](/start/menuband-symbolleiste) oder mit der Taste <kbd>F12</kbd> geöffnet werden.
