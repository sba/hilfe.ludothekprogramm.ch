...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/03.start/07.allgemeine-bedienung/docs.de.md',
    'modified' => 1786606028,
    'size' => 3138,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Allgemeine Bedienung\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => '#### Fenster schliessen (Registerkarte)
