...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/07.buchhaltung/03.buchungen/docs.de.md',
    'modified' => 1786606028,
    'size' => 1187,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Buchungen anzeigen\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das Fenster **Buchungen** können Sie mit dem Übersichtsbefehl **Buchhaltung → Buchungen** öffnen.
