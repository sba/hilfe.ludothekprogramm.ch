...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/06.beitrage-abos/docs.de.md',
    'modified' => 1786606028,
    'size' => 3051,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Beiträge / Abos\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Die Art und Höhe der jährlichen Beiträge, welche von Kunden entrichtet werden müssen können Sie hier definieren.
