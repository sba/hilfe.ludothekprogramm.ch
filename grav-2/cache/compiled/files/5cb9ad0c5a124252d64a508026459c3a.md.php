...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/02.installation/02.daten-update/docs.de.md',
    'modified' => 1786606028,
    'size' => 2146,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Daten Update\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => '## Office-Updates Dialog beim ersten Start:
