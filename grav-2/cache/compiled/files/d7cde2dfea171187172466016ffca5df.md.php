...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/04.spielbarcode/docs.de.md',
    'modified' => 1786606028,
    'size' => 1462,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Spiel-Barcode
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Die Etiketten zur Beschriftung der Spiele können auf A4 grosse Etikettenbogen oder einen DYMO Label-Writer gedruckt werden. Wenn Sie keinen Barcodescanner zum Einlesen der Nummer verwenden, können auch **Etiketten ohne Strichcode** gedruckt werden.
