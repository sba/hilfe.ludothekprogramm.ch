...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/11.anhang/02.lupo-admin/docs.de.md',
    'modified' => 1786606028,
    'size' => 9225,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'LUPO Admin\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das LUPO Admin Fenster enthält erweiterte Funktionen und ist für fortgeschrittene Benutzer und Administratoren gedacht. Das Fenster kann durch einen Button in den Allgemeinen Programmeinstellungen oder durch Drücken der Tastenkombination <kbd>Ctrl</kbd> + <kbd>F12</kbd> geöffnet werden.
