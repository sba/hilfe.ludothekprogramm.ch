...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/03.start/10.spiel-suchen/docs.de.md',
    'modified' => 1786606028,
    'size' => 1401,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Spiel suchen
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das **Spiel suchen** Fenster kann via dem **Menüband** oder dem Feldstecher-Button geöffnet werden.
