...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/03.spielinhalt/docs.de.md',
    'modified' => 1786606028,
    'size' => 1626,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Spielinhalt
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Unter Spielinhalt wird das Inventar eines Spiels verstanden (1 Spielanleitung, 3 Würfel, 21 Karten, …) Bestimmen Sie in diesem Einstellungsfenster das Erscheinungsbild des Ausdrucks.
