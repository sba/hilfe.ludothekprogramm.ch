...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/07.prolitteris/docs.de.md',
    'modified' => 1786606028,
    'size' => 1091,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: ProLitteris
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das schweizerische Urheberrechts-gesetz (URG) verlangt die Abgabe eines Teils der von den Benützern bezahlten Entgelte. Davon betroffen sind die Einnahmen aus Ausleihen von Ton- und Tonbildträger sowie Büchern.
