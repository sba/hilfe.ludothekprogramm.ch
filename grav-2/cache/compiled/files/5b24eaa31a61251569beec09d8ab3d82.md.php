...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/07.buchhaltung/07.buchungstexte-bearbeiten/docs.de.md',
    'modified' => 1786606028,
    'size' => 1482,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Buchungstexte bearbeiten\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das Fenster **Buchungstexte** können Sie mit **Übersicht → Buchhaltung → Buchungstexte bearbeiten** öffnen. Diese Buchungstexte sind die Auswahlmöglichkeiten in den **Buchen – Fenster** (Spiele ausleihen und zurücknehmen und Einzelbuchungen (manuell buchen)).
