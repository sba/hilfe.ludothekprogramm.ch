...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/07.buchhaltung/05.manuell-buchen-mit-vorgaben/docs.de.md',
    'modified' => 1786606028,
    'size' => 826,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Manuell buchen (mit Vorgaben)\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das **Einzelbuchung** Fenster können Sie mit **Übersicht → Buchhaltung → Manuell buchen** öffnen.
