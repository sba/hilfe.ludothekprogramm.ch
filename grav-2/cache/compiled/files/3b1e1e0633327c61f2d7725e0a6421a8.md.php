...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/05.kunden-abokarten/docs.de.md',
    'modified' => 1786606028,
    'size' => 1387,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Kundenkarten\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Die Kundenbarcodes können entweder auf Etiketten, in Kreditkartengrösse oder auf A4-Vorlagen mit integrierter Karte (Card-in-Fold) gedruckt werden.
