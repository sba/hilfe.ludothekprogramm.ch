...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/14.ferien/docs.de.md',
    'modified' => 1786606028,
    'size' => 2009,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Ferien
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Der Ferienplan hilft Ihnen das Rückgabdatum (Stempeldatum) beim Ausleihen oder Verlängern so anzupassen, dass der Kunde das Spiel nicht dann zurückbringen muss, wenn die Ludothek geschlossen ist. Es besteht jederzeit die Möglichkeit das von der Software berechnete Rückgabedatum manuell zu verändern.
