...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/02.installation/04.stammdaten-erfassen/docs.de.md',
    'modified' => 1786606028,
    'size' => 1210,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Stammdaten erfassen\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => '## Bevor Sie mit dem Datenerfassen beginnen...
