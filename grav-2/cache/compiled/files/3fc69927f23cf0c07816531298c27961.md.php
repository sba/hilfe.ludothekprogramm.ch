...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/08.statistik-listen/03.spiele/docs.de.md',
    'modified' => 1786606028,
    'size' => 2519,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Spiele
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Zeigt alle Spielkinder an. Jedes Spielkind enthält auch die Daten seiner Spielfamilie.
