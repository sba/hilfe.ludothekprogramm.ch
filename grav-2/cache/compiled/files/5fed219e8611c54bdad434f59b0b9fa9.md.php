...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/15.email/docs.de.md',
    'modified' => 1786606028,
    'size' => 1923,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: E-Mail
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Mit LUPO können Mahnungen für verspätete Spiele und die Information, dass ein reserviertes Spiel abholbereit ist, per E-Mail versendet werden.
