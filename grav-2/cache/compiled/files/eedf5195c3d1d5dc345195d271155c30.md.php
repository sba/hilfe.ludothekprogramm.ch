...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/04.spiele-ausleihen/01.ausleihen_zurucknehmen/docs.de.md',
    'modified' => 1786606028,
    'size' => 3296,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Ausleihen und zurücknehmen\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das **Spiele ausleihen und zurücknehmen** Fenster können Sie via Übersicht oder mit der Symbolleiste öffnen.
