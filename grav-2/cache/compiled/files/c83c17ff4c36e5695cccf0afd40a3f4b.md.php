...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/01.spielkategorien/docs.de.md',
    'modified' => 1786606028,
    'size' => 2214,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Spielkategorien
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Die Allgemeinen Einstellungen erreichen Sie mit **Übersicht → Einstellungen → [Programmeinstellungen](/einstellungen/allgemeine-einstellungen)**
