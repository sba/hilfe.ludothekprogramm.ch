...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/10.ludothek-webseite/08.spielliste-website/docs.de.md',
    'modified' => 1786606028,
    'size' => 1783,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Spielliste aktualisieren\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Wenn an den Spiele-Daten etwas geändert oder ein neues Spielfoto erfasst wird, muss der komplette Spiele-Katalog im LUPO exportiert und auf der Webseite im Joomla-Administrator importiert werden.
