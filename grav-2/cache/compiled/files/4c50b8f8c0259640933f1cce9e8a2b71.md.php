...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/06.etiketten-briefe/02.spielbarcodes-drucken/docs.de.md',
    'modified' => 1786606028,
    'size' => 4286,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Spielbarcodes drucken\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das **Barcode Drucken** Fenster kann über die **Übersicht → Drucken → Barcodes Drucken** geöffnet werden.
