...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/05.spiele-und-adressen/04.mitarbeiter-arbeitszeiten/docs.de.md',
    'modified' => 1786606028,
    'size' => 1257,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Mitarbeiter Arbeitszeiten\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das **Mitarbeiter Arbeitszeiten** Fenster kann mit dem Übersichtsbefehl **Übersicht → Adressen, Spiele und Mitarbeiter → Arbeitszeiten** geöffnet werden.
