...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/04.spiele-ausleihen/06.ausleihdauer-verlangern/docs.de.md',
    'modified' => 1786606028,
    'size' => 1613,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Ausleihdauer Verlängern\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Klicken Sie auf <span class="btn-lupo">Verlängern</span> im Spiele Ausleihen und Zurücknehmen Fenster um den folgenden Dialog angezeigt zu bekommen:
