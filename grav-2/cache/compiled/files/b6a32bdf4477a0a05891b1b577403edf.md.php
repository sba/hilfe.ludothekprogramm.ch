...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/10.ludothek-webseite/02.website-login/docs.de.md',
    'modified' => 1786606028,
    'size' => 1465,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Website-Login\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Die Inhalte und der Aufbau der Webseite können mit einem Benutzer-Login komplette kontrolliert werden. Mit dem CMS Joomla können kleinere Anpassungen an Beiträgen oder Modulen im Frontend ausgeführt werden. Für Änderungen an der Struktur (z.B. Menü) muss das Administrator-Fenster geöffnet werden.
