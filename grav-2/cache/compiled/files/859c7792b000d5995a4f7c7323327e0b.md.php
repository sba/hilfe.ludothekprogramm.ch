...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/02.installation/01.setup/docs.de.md',
    'modified' => 1786606028,
    'size' => 4020,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Setup ausführen\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => '!!! Der Windows-Benutzer, mit welchem LUPO später verwendet wird, muss während der Installation über Administrator-Rechte verfügen.
