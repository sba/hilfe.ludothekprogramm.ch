...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/03.start/01.lupo-starten/docs.de.md',
    'modified' => 1786606028,
    'size' => 1176,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'LUPO Starten\'
taxonomy:
    category:
        - docs
process:
    ...
    twig: true
visible: true',
        'markdown' => 'Normalerweise befindet sich das Smile-Programmicon auf dem Desktop. Falls es dort gelöscht wurde kann LUPO über das Startmenü ausgeführt werden.
