...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/08.ausleihen/docs.de.md',
    'modified' => 1786606028,
    'size' => 4496,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Ausleihen
taxonomy:
    category:
        - docs

visible: true',
        'markdown' => 'Bei den Ausleih-Einstellungen kann das Aussehen und Verhalten von Funktionen im Spiele ausleihen und zurücknehmen Fensters definiert werden.
