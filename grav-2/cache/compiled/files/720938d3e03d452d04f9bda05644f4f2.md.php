...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/06.etiketten-briefe/01.spielinhalte-drucken/docs.de.md',
    'modified' => 1786606028,
    'size' => 2072,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Spielinhalte drucken\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das **Spielinhalt Drucken** Fenster kann über die **Übersicht → Drucken → Spielinhalt drucken** geöffnet werden.
