...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/11.anhang/03.fehlermeldungen/docs.de.md',
    'modified' => 1786606028,
    'size' => 5328,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Fehlermeldungen
taxonomy:
    category:
        - docs',
        'markdown' => 'Falls eine Fehlermeldung erscheint, das LUPO-Programm abstürzt, ein Blue-Screen erscheint oder der PC unsanft durch einen Stromausfall abgeschaltet wird gehen keine Daten verloren. (Lediglich die letzte Eingabe ist ev. nicht gespeichert)
