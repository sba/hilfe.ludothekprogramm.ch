...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/04.spiele-ausleihen/05.spiele-zurucknehmen/docs.de.md',
    'modified' => 1786606028,
    'size' => 2185,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Spiele zurücknehmen\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Tragen die Spielnummer in das Spielnummernfeld ein und drücken dann den Button <span class="btn-lupo"> Rücknahme</span> oder <kbd>Enter</kbd>. Es wird automatisch zum Kunden, welcher das Spiel ausgeliehen hat, gewechselt.
