...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/04.spiele-ausleihen/02.kunden-suchen-und-erfassen/docs.de.md',
    'modified' => 1786606028,
    'size' => 2588,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Kunden suchen und erfassen\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Alle Aktionen (wie Abo lösen, Spiel ausleihen, reservieren, ...) die Sie im Fenster Spiele ausleihen und zurücknehmen ausführen, beziehen sich auf den rechts im Fenster angezeigten Kunden. Die linke Seite mit der Adressliste dient zum Suchen bestehender und Erfassen neuer Adressen.
