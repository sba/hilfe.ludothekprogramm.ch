...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/01.allgemeine-einstellungen/11.wertkarte-vorauszahlungen/docs.de.md',
    'modified' => 1786606028,
    'size' => 1646,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Ausleihkonto\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Gutschriftenkarten können verwendet werden, wenn auf im Voraus bezahlte Ausleihgebühren ein Rabatt gewährt werden soll oder wenn ein Kunde einen Geschenkgutschein der Ludo einlösen will.
