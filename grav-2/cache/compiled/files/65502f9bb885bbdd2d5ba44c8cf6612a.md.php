...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/03.start/08.datenblatt-filtern-und-sortieren/docs.de.md',
    'modified' => 1786606028,
    'size' => 1541,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Datenblatt filtern und sortieren\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Datenblätter enthalten eine tabellarische Darstellung von Daten. Der angezeigte Inhalt kann sortiert und/oder mit einem Filter eingeschränkt werden.
