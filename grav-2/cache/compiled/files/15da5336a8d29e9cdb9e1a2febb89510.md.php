...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/09.einstellungen/02.briefeinstellung/docs.de.md',
    'modified' => 1786606028,
    'size' => 2508,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Briefeinstellung
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das Aussehen der Briefe Mahnbrief, Reservationsbrief und Infobrief kann (mit beschränkten Möglichkeiten) Ihren Bedürfnissen entsprechend angepasst werden.
