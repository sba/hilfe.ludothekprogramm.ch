...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/03.start/02.notizblock/docs.de.md',
    'modified' => 1786606028,
    'size' => 652,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Notizblock
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Starten Sie **LUPO** mit dem Desktop-Icon oder über das Startmenü Als erstes Fenster öffnet Sich die **Übersicht**, dann darüber der **Notizblock**.
