...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/10.ludothek-webseite/03.beitrage/docs.de.md',
    'modified' => 1786606028,
    'size' => 4324,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Beiträge
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Ein Klick auf den Menüpunkt **Inhalt → Beiträge** öffnet die Seite zum Bearbeiten oder Erstellen von Beiträgen:
