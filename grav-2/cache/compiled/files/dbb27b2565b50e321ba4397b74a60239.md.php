...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/grav-2/user/pages/07.buchhaltung/02.tagesjournal-speichern/docs.de.md',
    'modified' => 1786606028,
    'size' => 4087,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Tagesjournal speichern\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das Fenster zum Speichern und Drucken des Tagesjournals kann vom **[Beenden Assistent](/start/beenden)** her, mit der Übersicht oder der Symbolleiste geöffnet werden.
