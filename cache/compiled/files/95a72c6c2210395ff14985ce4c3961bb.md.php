...
return [
    ...
    'filename' => 'D:/htdocs/hilfe2.ludothekprogramm.ch/user/pages/03.start/09.adresse-suchen/docs.de.md',
    'modified' => 1786611408,
    'size' => 1001,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: \'Adresse suchen\'
taxonomy:
    category:
        - docs
visible: true',
        'markdown' => 'Das **Adresse suchen** Fenster kann via dem **Menüband** oder dem Feldstecher-Button geöffnet werden.
